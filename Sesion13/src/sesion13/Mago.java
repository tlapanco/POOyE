...
public class Mago {
    ...
    private int turnosRecargaEspecial; // NUEVA PROPIEDAD
    ...
    // NUEVO SETTER
    public void setTurnosRecargaEspecial(int turnosRecargaEspecial) {
        this.turnosRecargaEspecial = turnosRecargaEspecial;
    }
    ...
    public int getTurnosRecargaEspecial() {
        return this.turnosRecargaEspecial;
    }
    ...
    public boolean getUsaHabilidadEspecial(int turnoActual) {
        return turnoActual % this.turnosRecargaEspecial == 0;
    }
}
